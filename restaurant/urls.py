...
from restaurant.views import (AboutPage, Homepage, ReservationCreateView,
                              ReservationListView, ReservationUpdateView,
                              reservation_cancel, reservation_confirm)
...
urlpatterns = [
    ...
    path(
        "reservation_confirm/<str:reservation_token>/",
        reservation_confirm,
        name="email_confirm",
    ),
    ...
    path(
        "reservations/<int:pk>/cancel/", reservation_cancel, name="reservation_cancel"
    ),
]
